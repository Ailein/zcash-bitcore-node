...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --daemon', 'Make zcash-bitcore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `zcash-bitcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ zcash-bitcore-node add wallet-service');
      console.log('    $ zcash-bitcore-node add zcash-insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ zcash-bitcore-node remove wallet-service');
      console.log('    $ zcash-bitcore-node remove zcash-insight-api');
      console.log();
    });

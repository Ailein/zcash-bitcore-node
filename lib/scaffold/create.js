...
var BASE_PACKAGE = {
  ...
  readme: 'README.md',
  dependencies: {
    'zcash-bitcore-lib': 'bitmex/zcash-bitcore-lib',
    'zcash-bitcore-node': 'bitmex/zcash-bitcore-node'
  }
};
...
function createConfigDirectory(options, configDir, isGlobal, done) {
  mkdirp(configDir, function(err) {
    ...
    try {
      fs.writeFileSync(configDir + '/zcash-bitcore-node.json', configJSON);
      if (!isGlobal) {
...
function create(options, done) {
  ...
  async.series([
    function(next) {
      // Setup the the zcash-bitcore-node directory and configuration

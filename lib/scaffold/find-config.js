...
/**
 * Will return the path and zcash-bitcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'zcash-bitcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'zcash-bitcore-node.json'))
  };
}
